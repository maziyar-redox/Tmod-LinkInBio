...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "arrow", size = "icon", ...props }, ref) => {
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "arrow", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button
            ...
            {...props}
        >
            <RightArrow size={25} color="white" />
